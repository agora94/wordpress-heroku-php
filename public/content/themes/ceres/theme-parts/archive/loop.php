						...
						<?php } ?>
							<div class="space-archive-loop-meta-ins relative">
								...
								<div class="space-archive-loop-meta-info space-common-meta relative">
									<i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo get_the_date(); ?> <span><i class="fa fa-comment-o" aria-hidden="true"></i> <?php comments_number( '0', '1', '%' ); ?></span> <span><i class="fa fa-bar-chart" aria-hidden="true"></i> <?php if(function_exists('ceres_setPostViews')) { echo ceres_getPostViews(get_the_ID()); }?></span>
								</div>
