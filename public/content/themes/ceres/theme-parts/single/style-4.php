			...
			<div class="space-full-width-one relative">
				...
				<div class="space-single-page-wrap cont relative single-page-style-2">
					<div class="space-single-page white-15 relative">
						...
						<?php $src = wp_get_attachment_image_src(get_post_thumbnail_id(), 'ceres-single-img-2'); if ($src) { ?>
						...
						<div class="space-single-page-ins relative">
							<div class="space-single-page-box relative">
								<div class="space-single-page-img relative">
									<div class="space-single-page-img-meta space-common-meta relative">
										<i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo get_the_date(); ?> <span class="by"><?php esc_html_e( 'by', 'ceres' ); ?></span> <?php the_author_posts_link(); ?> <span class="by"><?php esc_html_e( 'in', 'ceres' ); ?></span> <?php the_category(', '); ?>
