...
function alia_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control('alia_header_description', array(
        ...
        'description' => esc_attr__( 'Allowed HTML Tags: a, em, br, strong.', 'alia' ),
        'section'    => 'header_settings_section',
        'settings'   => 'alia_header_description',
        'type' => 'textarea'
    ));
	...
	$share_buttons = array('facebook' => 'Facebook', 'twitter' => 'Twitter', 'gplus' => 'Google+', 'pinterest' => 'Pinterest', 'linkedin' => 'Linkedin', 'vk' => 'VK', 'tumblr' => 'Tumblr', 'reddit' => 'Reddit', 'pocket' => 'Pocket', 'stumbleupon' => 'Stumbleupon', 'telegram' => 'Telegram');
    ...
    $wp_customize->add_control('alia_cookies_description_text', array(
        ...
        'description' => esc_attr__( 'This text is used to tell your visitors that this site is using cookies, Allowed HTML Tags: a, em, br, strong.', 'alia' ),
        'section'    => 'footer_settings_section',
    ...
    $wp_customize->add_control('alia_cookies_links_text', array(
        ...
        'description' => esc_attr__( 'This text will appear just before the agree button to show your policies pages links, Allowed HTML Tags: a, em, br, strong.', 'alia' ),
        'section'    => 'footer_settings_section',
