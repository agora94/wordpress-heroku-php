							...
							<div class="row">
								...
								<div class="author_info_col col">
									...
									<div class="author_box_info_header">
										<h2 class="author_display_name title"><?php printf( '<a class="author_name_url url fn n" href="%1$s">%2$s</a>', esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ), get_the_author(get_the_author_meta( 'ID' )) ); ?></h2>
